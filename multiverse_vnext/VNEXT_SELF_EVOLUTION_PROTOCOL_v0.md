...
- do not alter protected scientific boundaries;
- do not introduce spend/external commitments;
- are fully reversible;
- retain audit evidence.

Fast path may compress Sandbox/Benchmark/Review, but cannot skip canonical CAS or receipts.
...
Emergency containment is not permanent promotion.
...
No role may create the change, define the only success metric, perform the only review, and grant final promotion for a material change.
