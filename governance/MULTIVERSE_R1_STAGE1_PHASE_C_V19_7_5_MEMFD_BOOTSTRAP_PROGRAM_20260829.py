...
SPEC = [
    ("https://raw.githubusercontent.com/fufufu1116/multiverse-research/8383efede79e5a3f03d3dbfdf4a38ada46e37c5b/governance/MULTIVERSE_R1_STAGE1_PHASE_C_V19_7_5_STEP2_6_PATH_REASSERT_PAYLOAD_20260829.sh", 3778, "a5ba299d8c2a319d6bf3f7ef2f9a773054372c77642bd782c841f008774e9c1c", "680db05323322766be6bdd7f2a2f2ef4607352bc", "step26"),
...
FAIL = "PHASE_C_V19_7_5_MEMFD_BOOTSTRAP_STOP_DELETE_CODESPACE"
...
def sealed_pair(data, name):
    original = os.memfd_create("phase-c-v19-7-5-" + name, os.MFD_ALLOW_SEALING)
    high = None
    try:
        pos = 0
        while pos < len(data):
