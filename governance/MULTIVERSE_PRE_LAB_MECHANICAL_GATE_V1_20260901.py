...
def main():
 ...
 require(addon,['multiverse-v36-v7r7-session-status.txt','PHASE_C_V19_7_36_V7R7_ARMED','STARTING_TRUSTED_GITHUB_SERVER_TIME','PHASE_C_V19_7_36_V7R6_SESSION_CHALLENGE ','PHASE_C_V19_7_36_V7R6_WAITING_FOR_EXTERNAL_SESSION_BINDING','O_EXCL','O_NOFOLLOW','STDOUT_RESTORE','DEVICE_CODE_SHOULD_REMAIN_TERMINAL_ONLY_AFTER_RESTORE','PHASE_C_V19_7_36_V7R7_ATTACH_READY_OBSERVABILITY_SELFTEST_PASS'], 'ATTACH_READY_STATUS_WIRING')
