...
def main():
 ...
 for needle in ['/workspaces/.codespaces/.persistedshare/multiverse-v36-v7r6-session-status.txt','PHASE_C_V19_7_36_V7R6_IPHONE_STATUS_CHANNEL_READY','PHASE_C_V19_7_36_V7R6_IPHONE_OBSERVABILITY_SELFTEST_PASS','PHASE_C_V19_7_36_V7R6_IPHONE_OBSERVABILITY_BEHAVIOR_SELFTEST_PASS','DEVICE_CODE_SHOULD_REMAIN_TERMINAL_ONLY_AFTER_RESTORE','os.O_EXCL','iphoneSafeStatusLine','device code 1234-5678','syscall.Dup2(originalFD, int(os.Stdout.Fd()))','trimmed == iphoneWaitingLine','time.After(2 * time.Second)','strings.Contains(statusText, downstream)','status.Close()']:
