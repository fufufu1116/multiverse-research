...
def main():
 ...
 for needle in ['multiverse-v36-session-gate-v7r4','build-selftest','MULTIVERSE_R1_STAGE1_PHASE_C_V19_7_36_IMPLEMENTATION_CANDIDATE_V7R4_EXTERNAL_SESSION_GATE_20260901.go','python-actual-use-selftest.py']:
  if needle not in d:fail('DOCKER_V7R4_WIRING',needle)
 ...
 a=json.loads(data('governance/MULTIVERSE_R1_STAGE1_PHASE_C_V19_7_36_V7R4_CANDIDATE_ASSEMBLY_MANIFEST_20260901.json'))
 if a.get('version')!='V19.7.36-v7r4' or a.get('authority')!='REVIEW_ONLY_NO_LIVE_AUTHORITY' or a.get('runtime')!='OFF':fail('ASSEMBLY_MANIFEST','authority')
