...
func openLockWithOperation(path string, operation int)(*os.File,error){
    ...
    if st.Uid!=0 || st.Mode&syscall.S_IFMT!=syscall.S_IFDIR || uint32(st.Mode&07777)!=00555 { syscall.Close(fd); return nil,fmt.Errorf("lock-anchor-class") }
