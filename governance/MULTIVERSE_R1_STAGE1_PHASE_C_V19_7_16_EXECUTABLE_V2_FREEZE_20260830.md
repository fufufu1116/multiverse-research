...
Scenario selection is filesystem-image based before loader entry and does not rely on variables surviving env -i. The unchanged complete loader remains the test boundary for 103..114 and success. Fallback115 is explicitly synthetic complete-source-equivalent evidence. Matrix JSON freezes transcript assertions, not a Core execution claim; Independent Lab must independently reproduce/validate them.
