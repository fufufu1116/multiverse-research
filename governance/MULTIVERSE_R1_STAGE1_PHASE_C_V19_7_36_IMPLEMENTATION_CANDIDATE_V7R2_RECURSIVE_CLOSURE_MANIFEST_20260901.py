...
ROOTS=['/usr/bin/python3','/usr/bin/git','/usr/bin/gh','/bin/false','/etc/ld.so.cache','/etc/ld.so.conf','/etc/ld.so.conf.d','/etc/ssl/certs','/usr/lib/git-core','/usr/lib/locale','/opt/multiverse/v36/pydeps','/opt/multiverse/v36/runtime-v7.py','/opt/multiverse/v36/step3.py','/opt/multiverse/v36/step3-binding.json','/usr/local/sbin/multiverse-v36-anchor-v7r2','/usr/local/sbin/multiverse-v36-control-v7r2']
def python_roots():
