...
PATHS=[
'/usr/local/sbin/multiverse-v36-session-gate-v7r5',
...
def main():
 b=json.dumps({'version':'V19.7.36-v7r5-image-identity','objects':[ident(p) for p in PATHS]},sort_keys=True,separators=(',',':')).encode()
 with open(OUT,'wb') as f:f.write(b)
 os.chown(OUT,0,0);os.chmod(OUT,0o444)
 print('PHASE_C_V19_7_36_V7R5_IMAGE_IDENTITY_SHA256='+hashlib.sha256(b).hexdigest())
