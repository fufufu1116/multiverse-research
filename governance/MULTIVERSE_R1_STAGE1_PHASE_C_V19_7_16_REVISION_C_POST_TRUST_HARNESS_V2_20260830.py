...
import hashlib,subprocess,tempfile,os,sys
...
if pb.returncode: raise SystemExit('correction builder failed')
L=pb.stdout.decode('ascii')
...
print('V7_CORRECTED_LOADER_EXPECTED_TRANSFORMATION_FAIL_CLOSED=PASS')
