#!/usr/bin/env python3
"""Relaxed-time PRE-only finalizer v3 for the locked 35-rider Keirin front.
...
This is a v3 candidate implementation. It keeps v1/v2 immutable and fixes
trusted-provider hostname false positives (notably oddspark.com).
"""
