#!/usr/bin/env python3
"""Relaxed-time PRE-only finalizer v4 for the locked 35-rider Keirin front.
...
This is a v4 candidate implementation. It keeps earlier versions immutable,
fixes trusted-provider hostname false positives (notably oddspark.com), and
closes explicit English payout/comment namespace gaps.
"""
