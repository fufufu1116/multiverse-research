...
def verify_receipt(candidate, cr, pr, rr, count):
    ...
    checks = {
        ...
        "holdout_sealed": r.get("ECON_HOLDOUT1000", {}).get("state") == "SEALED",
        "price_unaccessed": r.get("ECON_HOLDOUT1000", {}).get("Price_accessed") is False,
        "payout_unaccessed": r.get("ECON_HOLDOUT1000", {}).get("PAYOUT_accessed") is False,
        "unscored": r.get("ECON_HOLDOUT1000", {}).get("scored") is False,
