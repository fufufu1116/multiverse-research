...
def assess_preboom_window(window: PreBoomWindow) -> dict:
    ...
    # Mainstream retail expansion is useful confirmation near the peak, but if it
    # dominates at 180/90 days the system may simply be recognizing an already
    # obvious winner rather than detecting an early signal.
    hindsight_penalty = 0
